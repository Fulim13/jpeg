...
int main()
{
    vector<vector<vector<int>>> image_blocks = {
        ...
        {
            {90, 30, 57, 74, 68, 95, 122, 134},
            {60, 13, 12, 13, 12, 12, 13, 13},
            {65, 13, 15, 15, 18, 14, 14, 18},
            {50, 15, 15, 15, 15, 14, 15, 18},
            {64, 16, 15, 19, 16, 17, 16, 18},
            {59, 16, 14, 17, 17, 16, 17, 18},
            {55, 15, 15, 18, 16, 17, 18, 19},
            {50, 15, 14, 17, 16, 17, 18, 19},
        }};
    ...
    for (auto &image_block : image_blocks)
    {
        ...
        vector<int> rle_encoded_ac = run_length_encode_ac(zigzag);
